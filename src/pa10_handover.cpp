...
Task createTask() {
	Task t;
	t.stages()->setName("bimanual handover");

	// TODO: choose first arm based on initial position of object
	std::string tool_frame = "rh_tool_frame";
